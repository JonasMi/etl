...
var fieldModels = [ 
{
'name' : 'EMERGENCY_MEDICAL_RECORDS_ID',
'displayName' : '院内急诊留观病历id',
'type' : 'varchar(40)',
'javaName' : 'emergencyMedicalRecordsId',
'note' : '',
'nullable':false,
'check':''},
{
...
'check':'CV9900357'},
{
'name' : 'CN_DIS_DIAG_NAME',
'displayName' : '中医病名诊断名称',
'type' : 'varchar(40)',
'javaName' : 'cnDisDiagName',
'note' : '',
'nullable':true,
'check':''},
{
'name' : 'CN_SYM_DIAG_CODE',
'displayName' : '中医证候诊断代码',
'type' : 'varchar(20)',
...
'check':'CV9900357'},
{
'name' : 'CN_SYM_DIAG_NAME',
'displayName' : '中医证候诊断名称',
'type' : 'varchar(40)',
'javaName' : 'cnSymDiagName',
'note' : '',
'nullable':true,
'check':''},
{
...
'displayName' : '急诊抢救记录',
'type' : 'varchar(500)',
'javaName' : 'rescueRecord',
'note' : '',
'nullable':true,
'check':''},
{
'name' : 'RESCUE_NAME_LIST',
'displayName' : '参加抢救人员名单',
'type' : 'varchar(500)',
'javaName' : 'rescueNameList',
'note' : '',
'nullable':true,
'check':''},
{
...
'displayName' : '收入观察室日期时间',
'type' : 'date',
'javaName' : 'observationTime',
'note' : '',
'nullable':true,
'check':'',
'valueHandler':datetimeValueHandler
