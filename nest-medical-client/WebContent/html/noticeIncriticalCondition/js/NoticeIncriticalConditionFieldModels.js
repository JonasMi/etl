...
var fieldModels = [ 
{
'name' : 'NOTICE_INCRITICAL_CONDITION_ID',
'displayName' : '院内病危（重）通知书id',
'type' : 'varchar(40)',
'javaName' : 'noticeIncriticalConditionId',
'note' : '',
'nullable':false,
'check':''},
{
...
{
'name' : 'CONDITION_AND_MAIN_MEASURE',
'displayName' : '病情概况以及主要抢救措施',
'type' : 'varchar(500)',
'javaName' : 'conditionAndMainMeasure',
'note' : '',
'nullable':true,
'check':''},
{
'name' : 'CRITICALLY_ILL_NOTICE_CONTENT',
'displayName' : '病危（重）通知内容',
'type' : 'varchar(200)',
'javaName' : 'criticallyIllNoticeContent',
'note' : '',
'nullable':true,
'check':''},
{
'name' : 'CRITICALLY_ILL_NOTICE_DATE',
'displayName' : '病危（重）通知时间',
'type' : 'date',
'javaName' : 'criticallyIllNoticeDate',
'note' : '',
'nullable':true,
'check':'',
'valueHandler':datetimeValueHandler
