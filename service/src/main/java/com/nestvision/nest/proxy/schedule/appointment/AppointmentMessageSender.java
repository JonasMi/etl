...
@Component
public class AppointmentMessageSender extends AbstractMultipleMessageSender<Appointment> {

    private static final String NEW_SOAPACTION = "http://www.aixin-health.com/platform/data/appointment/new";
    private static final String UPDATE_SOAPACTION = "http://www.aixin-health.com/platform/data/appointment/update";
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(Appointment message) {
        SoapRequest soapRequest = new SoapRequest();
        soapRequest.setSoapAction(detectSoapAction(message.getOperationState()));
        soapRequest.setResourceType("Appointment");
