...
@Component
public class ExamineOrderMessageSender extends AbstractMultipleMessageSender<ExamineOrder> {

    private static final String NEW_SOAPACTION = "http://www.aixin-health.com/platform/data/diagnosticorder/new";
    private static final String UPDATE_SOAPACTION = "http://www.aixin-health.com/platform/data/diagnosticorder/update";
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(ExamineOrder message) {
        SoapRequest soapRequest = new SoapRequest();
        soapRequest.setSoapAction(detectSoapAction(message.getOperationState()));
        soapRequest.setResourceType("DiagnosticOrder");
