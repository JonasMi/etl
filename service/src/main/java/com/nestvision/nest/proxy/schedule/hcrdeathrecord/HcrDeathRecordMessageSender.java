...
@Component
public class HcrDeathRecordMessageSender extends AbstractMultipleMessageSender<HcrDeathRecord> {

    private static final String NEW_SOAPACTION = "http://www.aixin-health.com/platform/data/hcrdeathrecord/new";
    private static final String UPDATE_SOAPACTION = "http://www.aixin-health.com/platform/data/hcrdeathrecord/update";
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(HcrDeathRecord message) {
        SoapRequest soapRequest = new SoapRequest();
        soapRequest.setSoapAction(detectSoapAction(message.getOperationState()));
        soapRequest.setResourceType("HcrDeathRecord");
