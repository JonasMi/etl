...
@Component
public class InhospitalDiagnosisMessageSender extends AbstractMultipleMessageSender<InhospitalDiagnosis> {
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(InhospitalDiagnosis message) {
