...
@Component
public class InInjuryExternalCauseMessageSender extends AbstractMultipleMessageSender<InInjuryExternalCause> {
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(InInjuryExternalCause message) {
