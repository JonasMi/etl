...
@Component
public class InspectOrderMessageSender extends AbstractMultipleMessageSender<InspectOrder> {
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(InspectOrder message) {
