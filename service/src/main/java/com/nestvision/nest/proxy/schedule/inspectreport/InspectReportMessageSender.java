...
@Component
public class InspectReportMessageSender extends AbstractMultipleMessageSender<InspectReport> {
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(InspectReport message) {
