...
@Component
public class MedicationMessageSender extends AbstractMultipleMessageSender<Medication> {

    private static final String NEW_SOAPACTION = "http://www.aixin-health.com/platform/data/medication/new";
    private static final String UPDATE_SOAPACTION = "http://www.aixin-health.com/platform/data/medication/update";
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(Medication message) {
        SoapRequest soapRequest = new SoapRequest();
        soapRequest.setSoapAction(detectSoapAction(message.getOperationState()));
        soapRequest.setResourceType("Medication");
