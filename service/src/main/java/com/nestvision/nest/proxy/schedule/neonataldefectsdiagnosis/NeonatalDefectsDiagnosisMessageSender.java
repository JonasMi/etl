...
@Component
public class NeonatalDefectsDiagnosisMessageSender extends AbstractMultipleMessageSender<NeonatalDefectsDiagnosis> {
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(NeonatalDefectsDiagnosis message) {
