...
@Component
public class OperationOrderMessageSender extends AbstractMultipleMessageSender<OperationOrder> {

    private static final String NEW_SOAPACTION = "http://www.aixin-health.com/platform/data/procedurerequest/new";
    private static final String UPDATE_SOAPACTION = "http://www.aixin-health.com/platform/data/procedurerequest/update";
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(OperationOrder message) {
        SoapRequest soapRequest = new SoapRequest();
        soapRequest.setSoapAction(detectSoapAction(message.getOperationState()));
        soapRequest.setResourceType("ProcedureRequest");
