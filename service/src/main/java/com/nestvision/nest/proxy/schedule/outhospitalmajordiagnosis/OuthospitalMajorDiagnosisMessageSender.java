...
@Component
public class OuthospitalMajorDiagnosisMessageSender extends AbstractMultipleMessageSender<OuthospitalMajorDiagnosis> {
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(OuthospitalMajorDiagnosis message) {
