...
@Component
public class OuthospitalOtherDiagnosisMessageSender extends AbstractMultipleMessageSender<OuthospitalOtherDiagnosis> {
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(OuthospitalOtherDiagnosis message) {
