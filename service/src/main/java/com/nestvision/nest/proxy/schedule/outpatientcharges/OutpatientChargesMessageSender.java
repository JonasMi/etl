...
@Component
public class OutpatientChargesMessageSender extends AbstractMultipleMessageSender<OutpatientCharges> {
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(OutpatientCharges message) {
