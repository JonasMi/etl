...
@Component
public class OutpatientDiagnosisMessageSender extends AbstractMultipleMessageSender<OutpatientDiagnosis> {
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(OutpatientDiagnosis message) {
