...
@Component
public class OutpatientRegistrationMessageSender extends AbstractMultipleMessageSender<OutpatientRegistration> {
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(OutpatientRegistration message) {
