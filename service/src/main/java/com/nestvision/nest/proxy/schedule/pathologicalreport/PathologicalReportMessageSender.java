...
@Component
public class PathologicalReportMessageSender extends AbstractMultipleMessageSender<PathologicalReport> {

    private static final String NEW_SOAPACTION = "http://www.aixin-health.com/platform/data/pathologicalreport/new";
    private static final String UPDATE_SOAPACTION = "http://www.aixin-health.com/platform/data/pathologicalreport/update";
    ...
    @Override
    protected List<SoapRequest> createSoapRequests(PathologicalReport message) {
        SoapRequest soapRequest = new SoapRequest();
        soapRequest.setSoapAction(detectSoapAction(message.getOperationState()));
        soapRequest.setResourceType("PathologicalReport");
