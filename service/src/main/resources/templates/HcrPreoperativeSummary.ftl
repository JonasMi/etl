	...
	<entry>
		...
		<resource>
			...
			<Composition xmlns="http://hl7.org/fhir">
				...
				<!-- 术前小结id -->
				<identifier>
					<system value="http://www.nestvision.com/entity/hospital/${upHospital}/${developerSystemType}/${developer}/v1/identifier/hcr-preoperative-summary-id" />
					<#if hcrPreoperativeSummaryId??>
					<value value="${hcrPreoperativeSummaryId}" />
					</#if>
				</identifier>
				<#if date??>
				<!-- 记录日期 -->
				...
				<!-- 手术操作章节 -->
				<section>
				<#if operationAdaptation??>
					<!-- 手术适应证 -->
					<extension url="http://www.nestvision.com/platform/app/data/v1/text/operation-adaptation">
						<valueString value="${operationAdaptation}"/>
					</extension>
					</#if>
				...
				<#if mattersNeedingAttention??>
					...
					<!-- 手术要点 -->
					<extension url="http://www.nestvision.com/platform/app/data/v1/code/operative-key-points">
