	...
	<entry>
		...
		<resource>
			...
			<Composition xmlns="http://hl7.org/fhir">
				...
				<identifier>
					<system
						value="http://www.nestvision.com/entity/hospital/${upHospital}/${developerSystemType}/${developer}/v1/identifier/hypertension-patients-follow-up-service-id" />
					<#if hypertensionPatientsFollowUpServiceId??>
					<value value="${hypertensionPatientsFollowUpServiceId}" />
					</#if>
				</identifier>
				<#if date??>
				<!-- 记录日期 -->
				...
				<type>
					<coding>
						...
						<code value="HSDB04.01" />
					</coding>
					<text value="高血压患者随访服务" />
				</type>
				<!-- 文档标题：高血压患者随访服务 -->
				<title value="高血压患者随访服务" />
				...
				<section>
					...
					<code>
						<coding>
							<system value="http://loinc.org" />
							<code value="99999-25" />
							<display value="Follow-up evaluation section" />
						</coding>
					</code>
				</section>
				<!-- 转诊建议章节 -->
