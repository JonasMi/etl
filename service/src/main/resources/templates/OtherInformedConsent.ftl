    ...
    <entry>
        ...
        <resource>
            ...
            <Composition xmlns="http://hl7.org/fhir">
                ...
                <#if otherInformedConsentId??>
                <!-- 其他知情同意书id -->
                <identifier>
                    <system value="http://www.nestvision.com/entity/hospital/${upHospital}/${developerSystemType}/${developer}/v1/identifier/other-informed-consent-id" />
                    <value value="${otherInformedConsentId}" />
                </identifier>
                </#if>
                <#if date??>
                <!-- 记录日期 -->
                ...
                <!--知情同意章节-->
                <section>
                    <#if informedConsentName??>
                    <!-- 知情同意书名称 -->
                    <extension url="http://www.nestvision.com/platform/app/data/v1/text/informed-consent-name">
                        <valueString value="${informedConsentName}" />
                    </extension>
                    </#if>
                    <#if informedConsentContent??>
                    <!-- 知情同意内容 -->
                    <extension url="http://www.nestvision.com/platform/app/data/v1/text/informed-consent-content">
                        <valueString value="${informedConsentContent}" />
                    </extension>
                    </#if>
                    <title value="知情同意章节" />
                    <code>
                ...
                <section>
                    ...
                    <#if patientStatutoryAgentAdvice??>
                    <!--患者/法定代理人的意见 -->
                    <extension url="http://www.nestvision.com/platform/app/data/v1/text/patient-statutory-agent-advice">
                        <valueString value="${patientStatutoryAgentAdvice}" />
                    </extension>
                    </#if>
                    <title value="意见章节" />
                    <code>
