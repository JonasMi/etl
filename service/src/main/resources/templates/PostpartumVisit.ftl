	...
	<entry>
		...
		<resource>
			...
			<Composition xmlns="http://hl7.org/fhir">
				...
				<!-- 产后访视id -->
				<identifier>
					<system value="http://www.nestvision.com/entity/hospital/${upHospital}/${developerSystemType}/${developer}/v1/identifier/postpartum-visit-id" />
					<#if postpartumVisitId??>
					<value value="${postpartumVisitId}" />
					</#if>
				</identifier>
				<#if date??>
				<!-- 记录日期 -->
