    ...
    <entry>
        ...
        <resource>
            ...
            <Composition xmlns="http://hl7.org/fhir">
                ...
                <#if seriousCriticalNursingRecordId??>
                <!-- 病重（病危）护理记录id -->
                <identifier>
                    <system value="http://www.nestvision.com/entity/hospital/${upHospital}/${developerSystemType}/${developer}/v1/identifier/serious-critical-nursing-record-id" />
                    <value value="${seriousCriticalNursingRecordId}" />
                </identifier>
                </#if>
                <#if date??>
                <!-- 记录日期 -->
                ...
                <type>
                    ...
                    <text value="病重（病危）护理记录" />
                </type>
                <!-- 文档标题：病重（病危）护理记录 -->
                <title value="病重（病危）护理记录" />
                ...
                <attester>
                    ...
                    <#if chargeNurseDate??>
                    <!-- 签名日期 -->
                    <time value="${chargeNurseDate?string("yyyy-MM-dd")}T${chargeNurseDate?string("HH:mm:ss")}" />
                    </#if>
                    <party>
                ...
                <section>
                    ...
                    <#if ifRritability??>
                    <!-- 是否有过敏史 -->
                    <extension url="http://www.nestvision.com/platform/app/data/v1/boolean/if-rritability">
                ...
                <section>
                    ...
                    <#if heartRate??>
                    <!-- 心率（次/min） -->
                    <extension url="http://www.nestvision.com/platform/app/data/v1/number/heart-rate">
