            ...
            <Composition xmlns="http://hl7.org/fhir">
                ...
                <contained>
                    <ReferralRequest xmlns="http://hl7.org/fhir">
                        <id value="r1${tiMr.inpatientTransferId}" />
                        <contained>
                            <Organization xmlns="http://hl7.org/fhir">
                                <id value="r1o1" />
                                <identifier>
                                    ...
                                    <#if tiMr.inDpidId??>
                                    <!-- 院内科室ID号 -->
                                    <value value="{tiMr.inDpidId}" />
                                    </#if>
                                </identifier>
                                <#if tiMr.inDpidName??>
                                <!-- 科室名称 -->
                                <name value="${tiMr.inDpidName}" />
                                </#if>
                            </Organization>
                        </contained>
                        <contained>
                            <Organization xmlns="http://hl7.org/fhir">
                                <id value="r1o2${tiMr.inpatientTransferId}" />
                                <identifier>
                                    <!-- 院内科室ID号命名空间 -->
                                    <system
                                        value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/department-id" />
                                    <#if tiMr.outDpidId??>
                                    <!-- 院内科室ID号 -->
                                    <value value="${tiMr.outDpidId}" />
                                    </#if>
                                </identifier>
                                <#if tiMr.outDpidName??>
                                <!-- 科室名称 -->
                                <name value="${tiMr.outDpidName}" />
                                </#if>
                            </Organization>
                        </contained>
                        <contained>
                            <Location xmlns="http://hl7.org/fhir">
                                <id value="r1l1${tiMr.inpatientTransferId}" />
                                <identifier>
                                    <!--原系统床位ID号命名空间 -->
                                    <system
                                        value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/bed-id" />
                                    <#if tiMr.inDpidId?? && tiMr.inBedno??>
                                    <!-- 原系统床位ID号：入科科室ID号+“_”+入科床位号 -->
                                    <value value="${tiMr.inDpidId}_${tiMr.inBedno}" />
                                    </#if>
                                </identifier>
                            </Location>
                        </contained>
                        <contained>
                            <Location xmlns="http://hl7.org/fhir">
                                <id value="r1l2${tiMr.inpatientTransferId}" />
                                <identifier>
                                    <!--原系统床位ID号命名空间 -->
                                    <system
                                        value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/bed-id" />
                                    <#if tiMr.outDpidId?? && tiMr.outBednoId??>
                                    <!-- 原系统床位ID号：出科科室ID号+“_”+出科床位号 -->
                                    <value value="${tiMr.outDpidId}_${tiMr.outBednoId}" />
                                    </#if>
                                </identifier>
                            </Location>
                        </contained>
                        <contained>
                            <Practitioner xmlns="http://hl7.org/fhir">
                                <id value="r1pra1${tiMr.inpatientTransferId}" />
                                <identifier>
                                    <!-- 院内人员ID号命名空间 -->
                                    <system
                                        value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/employee-id" />
                                    <#if tiMr.inEmpId??>
                                    <!-- 院内人员ID号 -->
                                    <value value="${tiMr.inEmpId}" />
                                    </#if>
                                </identifier>
                                <name>
                                    <#if tiMr.inEmpName??>
                                    <!-- 姓名 -->
                                    <text value="${tiMr.inEmpName}" />
                                    </#if>
                                </name>
                            </Practitioner>
                        </contained>
                        ...
                        <extension
                            ...
                            <valueReference>
                                <reference value="#r1l1${tiMr.inpatientTransferId}" />
                            </valueReference>
                        </extension>
                        <!-- 转出床位信息id -->
                        <extension
                            ...
                            <valueReference>
                                <reference value="#r1l2${tiMr.inpatientTransferId}" />
                            </valueReference>
                        </extension>
                        <!-- 转出科室id -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/identifier/out-dpid">
                            <valueReference>
                                <reference value="#r1o2${tiMr.inpatientTransferId}" />
                            </valueReference>
                        </extension>
                        <#if tiMr.inDate??>
                        <!-- 转入时间 -->
                        <extension
                            ...
                            <valueDateTime value="${tiMr.inDate?string("yyyy-MM-dd")}T${tiMr.inDate?string("HH:mm:ss")}" />
                        </extension>
                        </#if>
                        <#if tiMr.outDate??>
                        <!-- 转出时间 -->
                        <extension
                            ...
                            <valueDateTime value="${tiMr.outDate?string("yyyy-MM-dd")}T${tiMr.outDate?string("HH:mm:ss")}" />
                        </extension>
                        </#if>
                        <identifier>
                            <!-- 原系统转诊id -->
                            ...
                            <#if tiMr.inpatientTransferId??>
                            <value value="${tiMr.inpatientTransferId}" />
                            </#if>
                        </identifier>
                        ...
                        <!-- 转入操作人id -->
                        <recipient>
                            <reference value="#r1pra1${tiMr.inpatientTransferId}" />
                        </recipient>
                    </ReferralRequest>
                </contained>
                </#list>
                    ...
                    <Condition xmlns="http://hl7.org/fhir">
                        ...
                        <code>
                            <coding>
                                ...
                                <#if tiMod.diagnosisCd??>
                                <!--诊断ICD-10编码（必填） -->
                                <code value="${tiMod.diagnosisCd}" />
                                </#if>
                                <#if tiMod.diagnosisValue??>
                                <display value="${tiMod.diagnosisValue}" />
                                </#if>
                            </coding>
                        </code>
                        <category>
                        ...
                        <verificationStatus />
                        <#if tiMod.onsetdatetime??>
                        <!--诊断时间 -->
                        <onsetDateTime value="${tiMod.onsetdatetime?string("yyyy-MM-dd")}" />
                        </#if>
                    </Condition>
                </contained>
                </#list>
                ...
                <contained>
                    ...
                    <Condition xmlns="http://hl7.org/fhir">
                        ...
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/admit-diag">
                            <valueDecimal value="${tiMpd.admitDiag}" />
                        </extension>
                        </#if>
                        <identifier>
                            <system
                                value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/condition-id" />
                            <#if tiMpd.diagnosisId??>
                            <!-- 原系统诊断记录id（必填） -->
                            <value value="${tiMpd.diagnosisId}" />
                            </#if>
                        </identifier>
                        <patient />
                        <code>
                            <coding>
                                <!--诊断ICD-10编码 -->
                                <system value="urn:oid:2.16.156.10011.2.3.3.11" />
                                <#if tiMpd.diagnosisCd??>
                                <!--诊断ICD-10编码（必填） -->
                                <code value="${tiMpd.diagnosisCd}" />
                                </#if>
                                <#if tiMpd.diagnosisValue??>
                                <display value="${tiMpd.diagnosisValue}" />
                                </#if>
                            </coding>
                        </code>
                        <!-- 诊断、症状类型代码 -->
                        ...
                        <verificationStatus />
                        <#if tiMpd.onsetdatetime??>
                        <!--诊断时间 -->
                        <onsetDateTime value="${tiMpd.onsetdatetime?string("yyyy-MM-dd")}" />
                        </#if>
                    </Condition>
                </contained>
                </#list>
                ...
                <#if tiMiieds??>
                <#list tiMiieds as tiMiied>
                <contained>
                    <!-- 损伤中毒外部原因记录 -->
                    <Condition xmlns="http://hl7.org/fhir">
                        <id value="c3" />
                        <#if tiMiied.admitDiag??>
                        <!-- 诊断顺位 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/admit-diag">
                            <valueDecimal value="${tiMiied.admitDiag}" />
                        </extension>
                        </#if>
                        <identifier>
                            <system
                                value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/condition-id" />
                            <#if tiMiied.diagnosisId??>
                            <!-- 原系统诊断记录id（必填） -->
                            <value value="${tiMiied.diagnosisId}" />
                            </#if>
                        </identifier>
                        <patient />
                        <!-- 损伤中毒外部原因代码 -->
                        <code>
                            <coding>
                                <!--损伤中毒外部原因ICD-10编码 -->
                                <system value="urn:oid:2.16.156.10011.2.3.3.11" />
                                <#if tiMiied.diagnosisCd??>
                                <!--损伤中毒外部原因ICD-10编码（必填） -->
                                <code value="${tiMiied.diagnosisCd}" />
                                </#if>
                                <#if tiMiied.diagnosisValue??>
                                <display value="${tiMiied.diagnosisValue}" />
                                </#if>
                            </coding>
                        </code>
                        <!-- 诊断、症状类型 -->
                        ...
                        <verificationStatus />
                        <#if tiMiied.onsetdatetime??>
                        <!--诊断时间 -->
                        <onsetDateTime value="${tiMiied.onsetdatetime?string("yyyy-MM-dd")}" />
                        </#if>
                    </Condition>
                </contained>
                </#list>
                ...
                <contained>
                    ...
                    <Condition xmlns="http://hl7.org/fhir">
                        ...
                        <identifier>
                            <system
                                value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/condition-id" />
                            <#if tiMndd.diagnosisId??>
                            <!-- 原系统诊断记录id（必填） -->
                            <value value="${tiMndd.diagnosisId}" />
                            </#if>
                        </identifier>
                        <patient />
                        <!-- 症状代码 -->
                        <code>
                            <coding>
                                <!--症状ICD-10编码 -->
                                <system value="urn:oid:2.16.156.10011.2.3.3.11" />
                                <#if tiMndd.diagnosisCd??>
                                <!--症状ICD-10编码（必填） -->
                                <code value="${tiMndd.diagnosisCd}" />
                                </#if>
                                <#if tiMndd.diagnosisValue??>
                                <display value="${tiMndd.diagnosisValue}" />
                                </#if>
                            </coding>
                        </code>
                        <!-- 诊断、症状类型 -->
                        ...
                        <verificationStatus />
                        <#if tiMndd.onsetdatetime??>
                        <!--诊断时间 -->
                        <onsetDateTime value="${tiMndd.onsetdatetime?string("yyyy-MM-dd")}" />
                        </#if>
                    </Condition>
                </contained>
                </#list>
                ...
                <contained>
                    ...
                    <Condition xmlns="http://hl7.org/fhir">
                        ...
                        <extension
                            ...
                            <valueCode value="${tiMid.propertyCd}" />
                        </extension>
                        </#if>
                        <#if tiMid.diagExplan??>
                        <!-- 诊断说明 -->
                        <extension
                            ...
                            <valueString value="${tiMid.diagExplan}" />
                        </extension>
                        </#if>
                        <#if tiMid.admitDiag??>
                        <!-- 诊断顺位 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/admit-diag">
                            <valueDecimal value="${tiMid.admitDiag?string('#')}" />
                        </extension>
                        </#if>
                        <identifier>
                            <system
                                value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/condition-id" />
                            <#if tiMid.diagnosisId??>
                            <!-- 原系统诊断记录id（必填） -->
                            <value value="${tiMid.diagnosisId}" />
                            </#if>
                        </identifier>
                        <patient />
                        <code>
                            <coding>
                                <!--诊断ICD-10编码 -->
                                <system value="urn:oid:2.16.156.10011.2.3.3.11" />
                                <#if tiMid.diagnosisCd??>
                                <!--诊断ICD-10编码（必填） -->
                                <code value="${tiMid.diagnosisCd}" />
                                </#if>
                                <#if tiMid.diagnosisValue??>
                                <display value="${tiMid.diagnosisValue}" />
                                </#if>
                            </coding>
                        </code>
                        <!-- 诊断、症状类型代码 -->
                        ...
                        <verificationStatus />
                        <#if tiMid.onsetdatetime??>
                        <!--诊断时间 -->
                        <onsetDateTime value="${tiMid.onsetdatetime?string("yyyy-MM-dd")}" />
                        </#if>
                    </Condition>
                </contained>
                </#list>
                ...
                <#if tiMomds??>
                <#list tiMomds as tiMomd>
                <contained>
                    <!-- 出院主要诊断 -->
                    <Condition xmlns="http://hl7.org/fhir">
                        <id value="c6" />
                        <#if tiMomd.tcmWesternCd??>
                        <!-- 中西医诊断标志 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/code/tcm-western-cd">
                            <valueCode value="${tiMomd.tcmWesternCd}" />
                        </extension>
                        </#if>
                        <#if tiMomd.inhosIllnessCd??>
                        <!-- 入院病情代码 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/code/inhos-illness-cd">
                            <valueCode value="${tiMomd.inhosIllnessCd}" />
                        </extension>
                        </#if>
                        <#if tiMomd.treatmentResultCode??>
                        <!-- 治疗结果代码 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/code/treatment-result-code">
                            <valueCode value="${tiMomd.treatmentResultCode}" />
                        </extension>
                        </#if>
                        <#if tiMomd.propertyCd??>
                        <!-- 诊断性质代码 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/code/property-cd">
                            <valueCode value="${tiMomd.propertyCd}" />
                        </extension>
                        </#if>
                        <#if tiMomd.diagExplan??>
                        <!-- 诊断说明 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/text/diag-explan">
                            <valueString value="${tiMomd.diagExplan}" />
                        </extension>
                        </#if>
                        <#if tiMomd.admitDiag??>
                        <!-- 诊断顺位 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/admit-diag">
                            <valueDecimal value="${tiMomd.admitDiag?string('#')}" />
                        </extension>
                        </#if>
                        <identifier>
                            <system
                                value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/condition-id" />
                            <#if tiMomd.diagnosisId??>
                            <!-- 原系统诊断记录id（必填） -->
                            <value value="${tiMomd.diagnosisId}" />
                            </#if>
                        </identifier>
                        <patient />
                        <code>
                            <coding>
                                <!--诊断ICD-10编码 -->
                                <system value="urn:oid:2.16.156.10011.2.3.3.11" />
                                <#if tiMomd.diagnosisCd??>
                                <!--诊断ICD-10编码（必填） -->
                                <code value="${tiMomd.diagnosisCd}" />
                                </#if>
                                <#if tiMomd.diagnosisValue??>
                                <display value="${tiMomd.diagnosisValue}" />
                                </#if>
                            </coding>
                        </code>
                        <!-- 诊断、症状类型代码 -->
                        ...
                        <verificationStatus />
                        <#if tiMomd.onsetdatetime??>
                        <!--诊断时间 -->
                        <onsetDateTime value="${tiMomd.onsetdatetime?string("yyyy-MM-dd")}" />
                        </#if>
                    </Condition>
                </contained>
                </#list>
                ...
                <#if tiMoods??>
                <#list tiMoods as tiMood>
                <contained>
                    <!-- 出院其它诊断 -->
                    <Condition xmlns="http://hl7.org/fhir">
                        <id value="c7" />
                        <#if tiMood.tcmWesternCd??>
                        <!-- 中西医诊断标志 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/code/tcm-western-cd">
                            <valueCode value="${tiMood.tcmWesternCd}" />
                        </extension>
                        </#if>
                        <#if tiMood.inhosIllnessCd??>
                        <!-- 入院病情代码 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/code/inhos-illness-cd">
                            <valueCode value="${tiMood.inhosIllnessCd}" />
                        </extension>
                        </#if>
                        <#if tiMood.treatmentResultCode??>
                        <!-- 治疗结果代码 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/code/treatment-result-code">
                            <valueCode value="${tiMood.treatmentResultCode}" />
                        </extension>
                        </#if>
                        <#if tiMood.propertyCd??>
                        <!-- 诊断性质代码 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/code/property-cd">
                            <valueCode value="${tiMood.propertyCd}" />
                        </extension>
                        </#if>
                        <#if tiMood.diagExplan??>
                        <!-- 诊断说明 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/text/diag-explan">
                            <valueString value="${tiMood.diagExplan}" />
                        </extension>
                        </#if>
                        <#if tiMood.admitDiag??>
                        <!-- 诊断顺位 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/admit-diag">
                            <valueDecimal value="${tiMood.admitDiag?string('#')}" />
                        </extension>
                        </#if>
                        <identifier>
                            <system
                                value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/condition-id" />
                            <#if tiMood.diagnosisId??>
                            <!-- 原系统诊断记录id（必填） -->
                            <value value="${tiMood.diagnosisId}" />
                            </#if>
                        </identifier>
                        <patient />
                        <code>
                            <coding>
                                <!--诊断ICD-10编码 -->
                                <system value="urn:oid:2.16.156.10011.2.3.3.11" />
                                <#if tiMood.diagnosisCd??>
                                <!--诊断ICD-10编码（必填） -->
                                <code value="${tiMood.diagnosisCd}" />
                                </#if>
                                <#if tiMood.diagnosisValue??>
                                <display value="${tiMood.diagnosisValue}" />
                                </#if>
                            </coding>
                        </code>
                        <!-- 诊断、症状类型代码 -->
                        ...
                        <verificationStatus />
                        <#if tiMood.onsetdatetime??>
                        <!--诊断时间 -->
                        <onsetDateTime value="${tiMood.onsetdatetime?string("yyyy-MM-dd")}" />
                        </#if>
                    </Condition>
                </contained>
                </#list>
                ...
                <contained>
                    ...
                    <Condition xmlns="http://hl7.org/fhir">
                        ...
                        <extension
                            ...
                            <valueDateTime value="${tiMis.onsetDate?string("yyyy-MM-dd")}T${tiMis.onsetDate?string("HH:mm:ss")}" />
                        </extension>
                        </#if>
                        <identifier>
                            <system
                                value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/condition-id" />
                            <#if tiMis.diagnosisId??>
                            <!-- 原系统症状记录id（必填） -->
                            <value value="${tiMis.diagnosisId}" />
                            </#if>
                        </identifier>
                        <patient />
                        <!-- 症状代码 -->
                        <code>
                            <coding>
                                <!--症状ICD-10编码 -->
                                <system value="urn:oid:2.16.156.10011.2.3.3.11" />
                                <#if tiMis.diagnosisCd??>
                                <!--症状ICD-10编码（必填） -->
                                <code value="${tiMis.diagnosisCd}" />
                                </#if>
                                <#if tiMis.diagnosisValue??>
                                <display value="${tiMis.diagnosisValue}" />
                                </#if>
                            </coding>
                        </code>
                        <!-- 诊断、症状类型 -->
                        ...
                        <verificationStatus />
                        <#if tiMis.onsetdatetime??>
                        <!--诊断时间（必填） -->
                        <onsetDateTime value="${tiMis.onsetdatetime?string("yyyy-MM-dd")}" />
                        </#if>
                    </Condition>
                </contained>
                </#list>
                ...
                <contained>
                    ...
                    <Procedure xmlns="http://hl7.org/fhir">
                        ...
                        <contained>
                            <Practitioner xmlns="http://hl7.org/fhir">
                                ...
                                <identifier>
                                    ...
                                    <#if tiMo.operative??>
                                    <!-- 院内人员ID号 -->
                                    <value value="${tiMo.operative}" />
                                    </#if>
                                </identifier>
                                <name>
                                    <#if tiMo.operativeName??>
                                    <!-- 姓名 -->
                                    <text value="${tiMo.operativeName}" />
                                    </#if>
                                </name>
                            </Practitioner>
                        </contained>
                        <contained>
                            <Practitioner xmlns="http://hl7.org/fhir">
                                ...
                                <identifier>
                                    ...
                                    <system
                                        value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/employee-id" />
                                    <#if tiMo.firstAssistant??>
                                    <!-- 院内人员ID号 -->
                                    <value value="${tiMo.firstAssistant}" />
                                    </#if>
                                </identifier>
                                <name>
                                    <#if tiMo.firstAssistantName??>
                                    <!-- 姓名 -->
                                    <text value="${tiMo.firstAssistantName}" />
                                    </#if>
                                </name>
                            </Practitioner>
                        </contained>
                        <contained>
                            <Practitioner xmlns="http://hl7.org/fhir">
                                ...
                                <identifier>
                                    ...
                                    <system
                                        value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/employee-id" />
                                    <#if tiMo.secondAssistant??>
                                    <!-- 院内人员ID号 -->
                                    <value value="${tiMo.secondAssistant}" />
                                    </#if>
                                </identifier>
                                <name>
                                    <#if tiMo.secondAssistantName??>
                                    <!-- 姓名 -->
                                    <text value="${tiMo.secondAssistantName}" />
                                    </#if>
                                </name>
                            </Practitioner>
                        </contained>
                        <contained>
                            <Practitioner xmlns="http://hl7.org/fhir">
                                ...
                                <identifier>
                                    ...
                                    <#if tiMo.anaesthetic??>
                                    <!-- 院内人员ID号 -->
                                    <value value="${tiMo.anaesthetic}" />
                                    </#if>
                                </identifier>
                                <name>
                                    <#if tiMo.anaestheticName??>
                                    <!-- 姓名 -->
                                    <text value="${tiMo.anaestheticName}" />
                                    </#if>
                                </name>
                            </Practitioner>
                        </contained>
                        <#if tiMo.incisionTypeCode??>
                        <!-- 切口类别代码 -->
                        <extension url="urn:oid:2.16.156.10011.2.3.1.256">
                            <valueCode value="${tiMo.incisionTypeCode}" />
                        </extension>
                        </#if>
                        <#if tiMo.incisionHealingRankCode??>
                        <!-- 切口愈合级别代码 -->
                        <extension url="urn:oid:2.16.156.10011.2.3.1.257">
                            <valueCode value="${tiMo.incisionHealingRankCode}" />
                        </extension>
                        </#if>
                        <#if tiMo.opMark??>
                        <!-- 是否主要术式 -->
                        <extension
                            ...
                            <valueBoolean value="${tiMo.opMark?then('true','false')}" />
                        </extension>
                        </#if>
                        <#if tiMo.opProMark??>
                        <!-- 是否主要手术或操作 -->
                        <extension
                            ...
                            <valueBoolean value="${tiMo.opProMark?then('true','false')}" />
                        </extension>
                        </#if>
                        <#if tiMo.opLevelCd??>
                        <!-- 手术级别代码 -->
                        <extension
                            ...
                            <valueCode value="${tiMo.opLevelCd}" />
                        </extension>
                        </#if>
                        <#if tiMo.anesthesiaLevelCd??>
                        <!-- 麻醉分级代码 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/code/anesthesia-level-cd">
                            <valueCode value="${tiMo.anesthesiaLevelCd}" />
                        </extension>
                        </#if>
                        <#if tiMo.opNo??>
                        <!-- 手术操作序号 -->
                        <extension
                            ...
                            <valueString value="${tiMo.opNo}" />
                        </extension>
                        </#if>
                        <#if tiMo.operPatientTypeCode??>
                        <!-- 手术患者类型代码 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/code/oper-patient-type-code">
                            <valueCode value="${tiMo.operPatientTypeCode}" />
                        </extension>
                        </#if>
                        <#if tiMo.transfuseReactionFlag??>
                        <!-- 输血反应标志 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/boolean/transfuse-reaction-flag">
                            <valueBoolean value="${tiMo.transfuseReactionFlag?then('true','false')}" />
                        </extension>
                        </#if>
                        <#if tiMo.redBloodCell??>
                        <!-- 输红细胞量(单位) -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/red-blood-cell">
                            <valueDecimal value="${tiMo.redBloodCell?string('#')}" />
                        </extension>
                        </#if>
                        <#if tiMo.platelet??>
                        <!-- 输血小板量(袋) -->
                        <extension
                            ...
                            <valueDecimal value="${tiMo.platelet?string('#')}" />
                        </extension>
                        </#if>
                        <#if tiMo.plasma??>
                        <!-- 输血浆量(ml) -->
                        <extension
                            ...
                            <valueDecimal value="${tiMo.plasma?string('#')}" />
                        </extension>
                        </#if>
                        <#if tiMo.wholeBlood??>
                        <!-- 输全血量(ml) -->
                        <extension
                            ...
                            <valueDecimal value="${tiMo.wholeBlood?string('#')}" />
                        </extension>
                        </#if>
                        <#if tiMo.selfBlood??>
                        <!-- 自身回收(ml) -->
                        <extension
                            ...
                            <valueDecimal value="${tiMo.selfBlood?string('#')}" />
                        </extension>
                        </#if>
                        <#if tiMo.otherBlood??>
                        <!-- 输其它血制品量(ml) -->
                        <extension
                            ...
                            <valueDecimal value="${tiMo.otherBlood?string('#')}" />
                        </extension>
                        </#if>
                        <#if tiMo.lifeSupportMachineTime??>
                        <!-- 呼吸机使用时度（h） -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/life-support-machine-time">
                            <valueDecimal value="${tiMo.lifeSupportMachineTime?string('#')}" />
                        </extension>
                        </#if>
                        <identifier>
                            <!-- 原系统手术单id命名空间 -->
                        ...
                        <code>
                            <coding>
                                ...
                                <#if tiMo.anesthesiaMethodCd??>
                                <!-- 麻醉方法代码 -->
                                <code value="${tiMo.anesthesiaMethodCd}" />
                                </#if>
                                <#if tiMo.anesthesiaMethodName??>
                                <!-- 麻醉方法 -->
                                <display value="${tiMo.anesthesiaMethodName}" />
                                </#if>
                            </coding>
                            <coding>
                                <!-- 手术编码命名空间 -->
                                ...
                                <#if tiMo.operationCd??>
                                <!-- 手术编码 -->
                                <code value="${tiMo.operationCd}" />
                                </#if>
                                <#if tiMo.operationName??>
                                <!-- 手术名字 -->
                                <display value="${tiMo.operationName}" />
                                </#if>
                            </coding>
                        </code>
                        <bodySite>
                            <coding>
                                ...
                                <#if tiMo.partCode??>
                                <!-- 手术操作目标部位代码 -->
                                <code value="${tiMo.partCode}" />
                                </#if>
                                <#if tiMo.partName??>
                                <!-- 手术操作目标部位名称 -->
                                <display value="${tiMo.partName}" />
                                </#if>
                            </coding>
                        </bodySite>
                        <performer>
                        ...
                        <performedPeriod>
                            <#if tiMo.procedureStart??>
                            <!-- 手术开始时间（必填） -->
                            <start value="${tiMo.procedureStart?string("yyyy-MM-dd")}T${tiMo.procedureStart?string("HH:mm:ss")}" />
                            </#if>
                            <#if tiMo.procedureEnd??>
                            <!-- 手术结束时间 -->
                            <end value="${tiMo.procedureEnd?string("yyyy-MM-dd")}T${tiMo.procedureEnd?string("HH:mm:ss")}" />
                            </#if>
                        </performedPeriod>
                    </Procedure>
                </contained>
                ...
                <contained>
                    ...
                    <Claim xmlns="http://hl7.org/fhir">
                        ...
                        <#if feeGeneralTcmTreatment??>
                        <!-- 一般医疗服务费-中医辨证论治费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-general-tcm-treatment">
                            <valueDecimal value="${feeGeneralTcmTreatment?string("#")}" />
                        </extension>
                        </#if>
                        <#if feeGeneralTcmConsult??>
                        <!-- 一般医疗服务费-中医辨证论治会诊费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-general-tcm-consult">
                            <valueDecimal value="${feeGeneralTcmConsult?string("#")}" />
                        </extension>
                        </#if>
                        <#if feeGeneralTreat??>
                        <!-- 一般治疗操作费 -->
                        ...
                        <!-- 中医诊断费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-tcm-diag">
                            <valueDecimal value="${feeTcmDiag?string('#')}" />
                        </extension>
                        </#if>
                        <#if feeCnTreatment??>
                        <!-- 中医治疗费 -->
                        ...
                        <#if feeTcmForeignRule??>
                        <!-- 中医治疗费-中医外治费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-tcm-foreign-rule">
                            <valueDecimal value="${feeTcmForeignRule?string('#')}" />
                        </extension>
                        </#if>
                        <#if feeTcmOrthopedics??>
                        <!-- 中医治疗费-中医骨伤费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-tcm-orthopedics">
                            <valueDecimal value="${feeTcmOrthopedics?string('#')}" />
                        </extension>
                        </#if>
                        <#if feeTcmAcuMoxi??>
                        <!-- 中医治疗费-针刺与灸法费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-tcm-acu-moxi">
                            <valueDecimal value="${feeTcmAcuMoxi?string('#')}" />
                        </extension>
                        </#if>
                        <#if feeTcmMassage??>
                        <!-- 中医治疗费-中医推拿治疗费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-tcm-massage">
                            <valueDecimal value="${feeTcmMassage?string('#')}" />
                        </extension>
                        </#if>
                        <#if feeTcmAnorectal??>
                        <!-- 中医治疗费-中医肛肠治疗费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-tcm-anorectal">
                            <valueDecimal value="${feeTcmAnorectal?string('#')}" />
                        </extension>
                        </#if>
                        <#if feeTcmSpecial??>
                        <!-- 中医治疗费-中医特殊治疗费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-tcm-special">
                            <valueDecimal value="${feeTcmSpecial?string('#')}" />
                        </extension>
                        </#if>
                        <#if feeTcmOther??>
                        <!-- 中医其他费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-tcm-other">
                            <valueDecimal value="${feeTcmOther?string('#')}" />
                        </extension>
                        </#if>
                        <#if feeTcmSpecialMix??>
                        <!-- 中医其他费-中医特殊调配加工费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-tcm-special-mix">
                            <valueDecimal value="${feeTcmSpecialMix?string('#')}" />
                        </extension>
                        </#if>
                        <#if feeTcmDrugFood??>
                        <!-- 中医其他费-辨证施膳费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-tcm-drug-food">
                            <valueDecimal value="${feeTcmDrugFood?string('#')}" />
                        </extension>
                        </#if>
                        ...
                        <#if feeTcmOrgMedicine??>
                        <!-- 中成药费-医疗机构中药制剂费 -->
                        <extension
                            url="http://www.nestvision.com/platform/app/data/v1/number/fee-tcm-org-medicine">
                            <valueDecimal value="${feeTcmOrgMedicine?string('#')}" />
                        </extension>
                        </#if>
                        <#if feeBlood??>
                        <!-- 血费 -->
                ...
                <!-- 备注 -->
                <extension
                    url="http://www.nestvision.com/platform/app/data/v1/text/notes">
                ...
                <identifier>
                    <system
                        value="http://www.nestvision.com/entity/hospital/guan/his/sinosoft/v1/identifier/tcm-inpatient-medical-record-id" />
                    <#if tcmInpatientMedicalRecordId??>
                    <value value="${tcmInpatientMedicalRecordId}" />
                    </#if>
                </identifier>
                <#if date??>
                <!-- 记录日期 -->
                ...
                <section>
                    ...
                    <!--门（急）诊诊断 -->
                    <entry>
                        <reference value="#c1${tiMod.diagnosisId}" />
                    </entry>
                    </#list>
                    </#if>
                    <#if tiMpds ??>
                    ...
                    <!--病理诊断 -->
                    <entry>
                        <reference value="#c2${tiMpd.diagnosisId}" />
                    </entry>
                    </#list>
                    </#if>
                    <#if tiMids??>
                    ...
                    <!-- 入院诊断 -->
                    <entry>
                        <reference value="#c5${tiMid.diagnosisId}" />
                    </entry>
                    </#list>
                    </#if>
                </section>
                <section>
                    ...
                    <!--损伤中毒外部原因诊断 -->
                    <entry>
                        <reference value="#c3${tiMiied.diagnosisId}" />
                    </entry>
                    </#list>
                    </#if>
                    <#if tiMndds??>
                    ...
                    <!--新生儿缺陷诊断记录 -->
                    <entry>
                        <reference value="#c4${tiMndd.diagnosisId}" />
                    </entry>
                    </#list>
                    </#if>
                </section>
                <section>
                    ...
                    <!-- 转科信息 -->
                    <entry>
                        <reference value="#r1${tiMr.inpatientTransferId}" />
                    </entry>
                    </#list>
                    </#if>
                </section>
                <section>
                    ...
                    <!--出院主要诊断 -->
                    <entry>
                        <reference value="#c6${tiMomd.diagnosisId}" />
                    </entry>
                    </#list>
                    </#if>
                    <#if tiMoods??>
                    ...
                    <!--出院其它诊断 -->
                    <entry>
                        <reference value="#c7${tiMood.diagnosisId}" />
                    </entry>
                    </#list>
                    </#if>
                </section>
                ...
                <section>
                    ...
                    <!--住院病案症状记录 -->
                    <entry>
                        <reference value="#c8${tiMis.diagnosisId}" />
                    </entry>
                    </#list>
                    </#if>
                </section>
