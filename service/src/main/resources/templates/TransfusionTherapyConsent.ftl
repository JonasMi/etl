            ...
            <Composition xmlns="http://hl7.org/fhir">
                ...
                <contained>
                    ...
                    <Procedure xmlns="http://hl7.org/fhir">
                        ...
                        <!-- 输血史标识代码 -->
                        <extension  url="http://www.nestvision.com/platform/app/data/v1/code/transfuse-history-flag">
                            <valueCode value="${transfuseHistoryFlag}" />
                        </extension>
                        </#if>
                        <#if transfusionIndication??>
                        <!-- 输血指征 -->
                        <extension  url="http://www.nestvision.com/platform/app/data/v1/text/transfusion-indication">
                            <valueString value="${transfusionIndication}" />
                        </extension>
                        </#if>
                        <#if preTransfusionInspectionDescribe??>
                        <!-- 输血前有关检查项目以及结果 -->
                        <extension  url="http://www.nestvision.com/platform/app/data/v1/text/pre-transfusion-Inspection-describe">
                            <valueString value="${preTransfusionInspectionDescribe}" />
                        </extension>
                        </#if>
                        <#if transfusionWay??>
                        <!-- 输血方式 -->
                        <extension  url="http://www.nestvision.com/platform/app/data/v1/text/transfusion-way">
                            <valueString value="${transfusionWay}" />
                        </extension>
                        </#if>
                        <identifier>
                            <!-- 原系统输血单id命名空间 -->
                            <system value="http://www.nestvision.com/entity/hospital/${upHospital}/${developerSystemType}/${developer}/v1/identifier/metachysis-record-id" />
                            <#if metachysisRecordId??>
                            <!-- 原系统输血单id号 -->
                        ...
                        <performedPeriod>
                            ...
                            <!-- 输血开始时间 -->
                            <start value="${transfusionStartTime?string("yyyy-MM-dd")}T${transfusionStartTime?string("HH:mm:ss")}" />
                            </#if>
                            <#if transfusionEndTime??>
                            <!-- 输血结束时间 -->
                            <end value="${transfusionEndTime?string("yyyy-MM-dd")}T${transfusionEndTime?string("HH:mm:ss")}" />
                            </#if>
                        </performedPeriod>
                    </Procedure>
                </contained>
                ...
                <#if transfusionTherapyConsentId??>
                <!-- 输血治疗同意书id -->
                <identifier>
                    <system value="http://www.nestvision.com/entity/hospital/${upHospital}/${developerSystemType}/${developer}/v1/identifier/transfusion-therapy-consent-id" />
                    <value value="${transfusionTherapyConsentId}" />
                </identifier>
                </#if>
                <#if date??>
                <!-- 记录日期 -->
                ...
                <!-- 风险章节 -->
                <section>
                    <#if metachysisPossibleAccident??>
                    <!-- 输血风险及可能发生的不良后果 -->
                    <extension url="http://www.nestvision.com/platform/app/data/v1/text/metachysis-possible-accident">
                        <valueString value="${metachysisPossibleAccident}" />
                    </extension>
                    </#if>
                    <title value="风险章节" />
                    <code>
